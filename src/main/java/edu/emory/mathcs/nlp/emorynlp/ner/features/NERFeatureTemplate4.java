...
/**
 * Created by bong on 11/10/15. 93.01%
 */
public class NERFeatureTemplate4<N extends NLPNode> extends NERFeatureTemplate<N> {
    @Override
    protected void init() {
        // 1-gram features
        ...
        add(new FeatureItem<>(0, Field.ambiguity_class), new FeatureItem<>(1, Field.ambiguity_class), new FeatureItem<>(2, Field.ambiguity_class));
        ...
        add(new FeatureItem<>(-2, Field.ambiguity_class), new FeatureItem<>(-1, Field.ambiguity_class), new FeatureItem<>(0, Field.ambiguity_class));
